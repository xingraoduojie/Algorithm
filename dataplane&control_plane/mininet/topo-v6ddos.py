...
class TutorialTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.addLink(h1a, leaf1)  # port 2
        self.addLink(h1b, leaf1)  # port 3
        self.addLink(h1c, leaf1)  # port 4

        self.addLink(h2, leaf2)  # port 2
        
        self.addLink(h3a, leaf3)  # port 2
        self.addLink(h3b, leaf3)  # port 3
        self.addLink(h3c, leaf3)  # port 4
